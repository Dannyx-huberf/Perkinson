...
const Navigations = () => {
  return (
    <section className="lg:flex lg:justify-between lg:gap-[155px]">
      <div className="">
        <img src={logo} alt="perkinson-logo" className="w-[267px]" />
      </div>

      <div className="text-white  lg:flex lg:flex-1 lg:gap-[80px]">
        <div>
          <h1 className="text-24px font-projectfont font-[900] mb-3">
            Quick Links
          </h1>

          <ul className="font-projectfont2 text-textcolor font-[400] leading-[30px]  text-[17px]">
