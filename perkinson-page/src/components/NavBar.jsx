...
export default function NavBar() {
  ...
  return (
    <nav className="w-full lg:px-[100px]  py-2 relative">
      ...
      {/* Mobile menu */}
      {isOpen && (
        <div className="absolute top-full bg-white lg:bg-none left-0 w-full flex flex-col items-center py-6 lg:hidden space-y-4 z-50">
